...
## RUN ON CMD (Comand Prompt)
# Copy and Paste
# Step 1: Example; cd C:\Users\DELL\Jupyter\Data science advance\Financial_Risk (Copy your own directory 
#                  of the folder you saved this file in and make sure to add "cd" in front of it like the above example)
# Step 2: streamlit run financial_risk_app.py (Copy and past exactly as it is in you cmd)
...
with st.expander("Data"):
    st.write('**Raw Data**')
    df = pd.read_csv('C:/Users/DELL/Jupyter/Data science advance/Financial_Risk/Loan.csv')
    out = ["ApplicationDate", "Experience", "NumberOfDependents", "LoanPurpose", "JobTenure"]
    df.drop(out, axis= 1, inplace= True)
    df

    st.write('**Cleaned Data**')
    df2 = pd.read_csv('C:/Users/DELL/Jupyter/Data science advance/Financial_Risk/cleaned.csv')
    out = ["Unnamed: 0", "NumberOfDependents", "LoanPurpose", "JobTenure"]
